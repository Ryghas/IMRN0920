            ...
            <View style={styles.container}>
                ...
                <View style={styles.descContainer}>
                    ...
                    <View style={styles.videoDetail}>
                        <Text style={styles.videoTitile}>{video.snippet.title}</Text>
                        <Text style={styles.videoStatus}>{video.snippet.channelTitle + " . " + nFormatter(video.statistics.viewCount, 1)}</Text>
                    </View>
                    <TouchableOpacity>
